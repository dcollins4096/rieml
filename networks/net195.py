...
idd = 195
idd_text = "194 + kamming initialization"
...
class main_net(nn.Module):
    def __init__(self, output_length=1000, hidden_dims=(128, 128), conv_channels=32, characteristic=False):
        ...
        self.conv1.apply(init_weights_kaming)
        self.conv2.apply(init_weights_kaming)
        self.conv3.apply(init_weights_kaming)
        self.fc2.apply(init_weights_kaming)
